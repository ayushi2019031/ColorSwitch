...
public class LayeredCircles implements Obstacles, Serializable {
    ...
    public void display(AnchorPane pane, Game game){  c1 = new Circle_();
        ...
        c1.arc1.setRadiusX(70);
        c1.arc1.setRadiusY(70);
        ...
        c1.arc2.setRadiusX(70);
        c1.arc2.setRadiusY(70);
        ...
        c1.arc3.setRadiusX(70);
        c1.arc3.setRadiusY(70);
        ...
        c1.arc4.setRadiusX(70);
        c1.arc4.setRadiusY(70);
    ...
    public boolean isObstacleCrossed(Game game, LayeredCircles activeObstacle, Ball ball, AnchorPane Obstaclespane, Stage stage, boolean[] breking_bad, Text text4) {
